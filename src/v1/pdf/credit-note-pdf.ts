...
export const generateCreditNotePdf = (
  ...
  return new Promise((resolve, reject) => {
    ...
    // Add heading
    doc.fontSize(10).text('Credit Note', {
      align: 'center',
    })
    ...
    doc.text(
      `Credit Note No: ${data.creditNoteDetails.creditNoteNo}`,
      xRight - 1,
      y
    )
    doc.text(
      `Credit Note Date: ${data.creditNoteDetails.creditNoteDate}`,
      xRight - 1,
      y + 30
    )
    ...
    doc
      .moveTo(50, doc.y + 150)
      .lineTo(doc.page.width - 50, doc.y + 150)
      .stroke()
